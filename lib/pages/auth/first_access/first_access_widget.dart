...
class FirstAccessWidget extends StatefulWidget {
  const FirstAccessWidget({super.key});

  @override
  State<FirstAccessWidget> createState() => _FirstAccessWidgetState();
}

class _FirstAccessWidgetState extends State<FirstAccessWidget>
    with TickerProviderStateMixin {
  late FirstAccessModel _model;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'jasttay1' /* Eu já me apresentei, agora é s... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                options: List<String>.from(
                                    ['customer', 'owner', 'employee', '3']),
                                optionLabels: [
                                  FFLocalizations.of(context).getText(
                                    'kwff93x8' /* Encontrar um lugar pra ficar */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'fl8crzkr' /* Oferecer apartamentos */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'w2uq8x7g' /* Prestar serviços */,
                                  ),
                                  ''
                                ],
                                onChanged: (val) =>
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  '6rzh6h9g' /* Em que irei te ajudar? */,
                                ),
                                icon: Icon(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        '4f2lflwv' /* Qual o nome da sua empresa? */,
                                      ),
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await currentUserReference!
                                      .update(createUsersRecordData(
                                    company: _model.newCompany?.reference,
                                  ));
